...
export default function SuccessMessage() {
  ...
  return (
    <div>
      {showMessage && (
        <div style={{ textAlign: 'center', padding: '40px 0', background: '#EBF0F5', marginTop: '100px' }}>
          <div className="card" style={{ background: 'white', padding: '60px', borderRadius: '4px', boxShadow: '0 2px 3px #C8D0D8', display: 'inline-block', margin: '0 auto', width: '600px' }}>
